...
<html>
  <head>
    ...
    <script async src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBX3LK28LELaPEtAqa1cuvPmCTdLRbcRB4&callback=console.debug&libraries=maps,marker&v=beta">
    </script>
    <style>
